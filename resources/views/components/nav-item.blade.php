...
@php
$classes = $active
    ? 'flex items-center gap-3 px-4 py-3 rounded-lg bg-indigo-700 text-white'
    : 'flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-indigo-700 text-indigo-200 hover:text-white transition';
