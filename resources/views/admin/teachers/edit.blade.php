<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto mb-8">
        ...
        <p class="text-gray-500 mt-1">Perbarui informasi data diri dan jabatan guru.</p>
    </div>

    {{-- Perhatikan action route dan penambahan $teacher->id --}}
    <form method="POST" action="/teachers/{{ $teacher->id }}" enctype="multipart/form-data" class="max-w-4xl mx-auto">
        @csrf
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
            ...
            <div class="md:w-1/3 bg-gray-50 p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100 relative group">
                <div class="text-center w-full">
                    ...
                    <div class="relative w-48 h-48 mx-auto mb-2">
                        ...
                        <div class="w-full h-full rounded-full bg-white border-2 border-dashed {{ $errors->has('image_path') ? 'border-red-400' : 'border-indigo-300' }} flex flex-col items-center justify-center overflow-hidden relative">

                            {{-- Logic: Jika ada gambar lama, sembunyikan placeholder icon --}}
                            <div id="placeholder-icon" class="flex flex-col items-center {{ $teacher->image_path ? 'hidden' : '' }}">
                                ...
                                <span class="text-xs text-gray-500 font-medium">Ganti Foto</span>
                            </div>

                            {{-- Logic: Jika ada gambar lama, tampilkan di sini. Jika tidak, hidden. --}}
                            <img id="img-preview"
                                src="{{ $teacher->image_path ? asset('storage/' . $teacher->image_path) : '#' }}"
                                alt="Preview"
                                class="{{ $teacher->image_path ? '' : 'hidden' }} w-full h-full object-cover absolute inset-0" />
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 text-blue-700 px-4 py-3 rounded-lg text-xs text-left mx-auto max-w-xs border border-blue-100 mt-4">
                        <p class="font-bold mb-1">Catatan:</p>
                        <ul class="list-disc list-inside space-y-1">
                            <li>Biarkan kosong jika tidak ingin mengubah foto.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative mt-2">
                            ...
                            {{-- Value diisi dengan old('name', $teacher->name) --}}
                            <x-text-input id="name" name="name" type="text"
                                ...
                                placeholder="Contoh: Dr. Ahmad Fauzi, S.Pd"
                    ...
                    <div>
                        ...
                        <div class="relative mt-2">
                            ...
                            {{-- Value diisi dengan old('jabatan', $teacher->jabatan) --}}
                            <x-text-input id="jabatan" name="jabatan" type="text"
                                ...
                                :value="old('jabatan', $teacher->jabatan)" />
                        </div>
                        @error('jabatan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
        ...
        function previewImage(event) {
            ...
            reader.onload = function() {
                if (reader.readyState == 2) {
                    ...
                    imageField.classList.remove("hidden"); // Tampilkan gambar baru
